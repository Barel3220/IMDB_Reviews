...
def evaluate(agent_, test_loader_, is_last_epoch=False, percent_string=''):
    """
    ...
    if is_last_epoch:
        plot_confusion_matrix(all_labels, all_preds, [0, 1], 'double_dqn_confusion_matrix_' + percent_string + '.png')
